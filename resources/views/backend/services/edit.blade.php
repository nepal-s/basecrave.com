...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Service Update</h3>
            <ol class="breadcrumb">
                    ...
                    <form method="post" action="{{ route('services.update', $service->id) }}"
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="service" class="form-control" value="{{ $service->service_name }}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea name="description" id="description" class="form-control"
                                          placeholder="Write description here *" style="width: 100%; height: 80%;" required>{{ $service->description }}</textarea>
                            </div>
                        </div>
                        @if($service->image)
                            <div class="col-md-12">
                                ...
                                @if($service->image)
                                            <img id="image_preview"
                                                 src="{{asset('images').'/'.$service->image }}" height="100px"
