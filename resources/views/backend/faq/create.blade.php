                    ...
                    <form method="post" action="{{ route('faqs.store') }}"
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea  name="question" class="form-control" placeholder="Write question here with question mark *" required></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea name="answer" id="answer" class="form-control"
                                          placeholder="Write answer here *" style="width: 100%; height: 80%;" required></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
